...
def generate_init_conditions_closed_loop_inference(objects_color) -> InitConditionsClosedLoopInferenceSchema:
    """
...
def generate_init_conditions_closed_loop_inference_2choice(objects_color) -> InitConditionsClosedLoopInferenceSchema:
    """
    Specific implementation with weighted probabilities
...
def generate_init_conditions_closed_loop_inference_3choice_random(objects_color) -> InitConditionsClosedLoopInferenceSchema:
    """
    Specific implementation with weighted probabilities
...
def generate_init_conditions_closed_loop_inference_5object(objects_color) -> InitConditionsClosedLoopInferenceSchema:
    """
    Specific implementation with weighted probabilities
