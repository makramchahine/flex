...
class FlightILDataset(IterableDataset):
    def __init__(
            ...
            fixed_run_length: Optional[int] = None,
            **kwargs,
    ):
        ...
        self._fixed_run_length = fixed_run_length
            ...
            if not self._shuffle:
                ...
                for run in os.listdir(self.data_path):
                    ...
                    for j, text in enumerate(texts):
                        ...
                        num_images = len(labels) if self._fixed_run_length is None else self._fixed_run_length
                        ...
                        for i in range(num_images):
                            ...
                            # load the image
                            img = Image.open(os.path.join(run, image_names[i+1]))
                            # convert to RGB
                            img = img.convert('RGB')
